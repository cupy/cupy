...
class NStepRNN(link.ChainList):
    ...
    def __init__(
        ...
        super(NStepRNN, self).__init__(*weights)
...
class NStepBiRNN(link.ChainList):
    ...
    def __init__(
        ...
        super(NStepBiRNN, self).__init__(*weights)
