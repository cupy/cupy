...
_ascend_files = [
    ...
    'cupy._core._memory_range',
    'cupy._core._optimize_config',
    ('cupy._core._kernel', ['cupy/_ascend/_core/_kernel.pxd',
                          'cupy/_ascend/_core/_kernel.pyx']),
    ('cupy._core._routines_math', ['cupy/_ascend/_core/_routines_math.pxd',
                          'cupy/_ascend/_core/_routines_math.pyx']),
    ('cupy._core._routines_binary', ['cupy/_ascend/_core/_routines_binary.pxd',
