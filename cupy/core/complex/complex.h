/* This file is copied from thrust project and modified it.
...
template <typename T, typename U>
struct _select_greater_type : _select_greater_type_impl<T, U, (sizeof(T) > sizeof(U))> {};
 ...
 */
template<typename T> __device__ inline T abs(const complex<T>& z);
 ...
 */
template<typename T> __device__ inline complex<T> polar(const T& m, const T& theta = 0);
 ...
 */
template<typename T> __device__ inline complex<T> proj(const T& z);
 ...
 */
template <typename T> __device__ inline complex<T> operator*(const complex<T>& lhs, const complex<T>& rhs);
 ...
 */
template <typename T> __device__ inline complex<T> operator*(const complex<T>& lhs, const T & rhs);
 ...
 */
template <typename T> __device__ inline complex<T> operator*(const T& lhs, const complex<T>& rhs);
 ...
 */
template <typename T> __device__ inline complex<T> operator+(const complex<T>& rhs);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> exp(const complex<T>& z);

/*! Returns the complex natural logarithm of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> log(const complex<T>& z);

/*! Returns the complex base 10 logarithm of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ inline complex<T> log10(const complex<T>& z);
 ...
 */
template <typename T> __device__ complex<T> pow(const complex<T>& x, const complex<T>& y);
 ...
 */
template <typename T> __device__ complex<T> pow(const complex<T>& x, const T& y);
 ...
 */
template <typename T> __device__ complex<T> pow(const T& x, const complex<T>& y);
 ...
 *  \param y The exponent.
 */
template <typename T, typename U> __device__ complex<typename _select_greater_type<T,U>::type > pow(const complex<T>& x, const complex<U>& y);
 ...
 *  \param y The exponent.
 */
template <typename T, typename U> __device__ complex<typename _select_greater_type<T,U>::type > pow(const complex<T>& x, const U& y);
 ...
 *  \param y The exponent.
 */
template <typename T, typename U> __device__ complex<typename _select_greater_type<T,U>::type > pow(const T& x,const complex<U>& y);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> sqrt(const complex<T>&z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> cos(const complex<T>&z);

/*! Returns the complex sine of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> sin(const complex<T>&z);

/*! Returns the complex tangent of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> tan(const complex<T>&z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> cosh(const complex<T>& z);

/*! Returns the complex hyperbolic sine of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> sinh(const complex<T>&z);

/*! Returns the complex hyperbolic tangent of a \p complex number.
 *
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> tanh(const complex<T>&z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> acos(const complex<T>& z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> asin(const complex<T>& z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> atan(const complex<T>& z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> acosh(const complex<T>& z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> asinh(const complex<T>& z);
 ...
 *  \param z The \p complex argument.
 */
template <typename T> __device__ complex<T> atanh(const complex<T>& z);
 ...
 *  \param rhs The second \p complex.
 */
template <typename T> __device__ inline bool operator==(const complex<T>& lhs, const complex<T>& rhs);
 ...
 *  \param rhs The \p complex.
 */
template <typename T> __device__ inline bool operator==(const T & lhs, const complex<T>& rhs);
 ...
 *  \param rhs The scalar.
 */
template <typename T> __device__ inline bool operator==(const complex<T> & lhs, const T& rhs);
