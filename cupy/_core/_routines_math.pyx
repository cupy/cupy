...
_remainder = create_ufunc(
    ...
    ('bb->b', 'BB->B', 'hh->h', 'HH->H', 'ii->i', 'II->I', 'll->l', 'LL->L',
     'qq->q', 'QQ->Q',
     ('ee->e', 'out0 = (in1 == INFINITY) ? in0 : in0 - _floor_divide(in0, in1) * in1'),
     ('ff->f', 'out0 = (in1 == INFINITY) ? in0 : in0 - _floor_divide(in0, in1) * in1'),
     ('dd->d', 'out0 = (in1 == INFINITY) ? in0 : in0 - _floor_divide(in0, in1) * in1')),
    'out0 = (in1 == INFINITY) ? in0 : (in0 - _floor_divide(in0, in1) * in1) * (in1 != 0)',
