...
cdef class _ArgInfo:
    ...
    cdef str get_c_type(self, preambles=*)

    cdef str get_param_c_type(self, ParameterInfo p, preambles=*)
...
cdef class _TypeMap:
    ...
    cdef str get_typedef_code(self, preambles=*)
...
cdef str _get_kernel_params(tuple params, tuple arginfos, preambles=*)
