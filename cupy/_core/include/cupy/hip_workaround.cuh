...
// ROCm threads march in lock-step, so the sync mask is meaningless.
// Map to mask-less variants unconditionally (see https://github.com/cupy/cupy/issues/9829 for details).
