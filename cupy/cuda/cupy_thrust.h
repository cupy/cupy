...
template <typename T> void _sort(char, void *, size_t *, const std::vector<ptrdiff_t>&);
...
template <typename T> void _sort(char, void *, size_t *, const std::vector<ptrdiff_t>&) { return; }
