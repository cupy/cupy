...
void cub_device_reduce(void*, size_t&, void*, void*, int, intptr_t, int, int);
void cub_device_segmented_reduce(void*, size_t&, void*, void*, int, int, intptr_t, int, int);
void cub_device_spmv(void*, size_t&, void*, void*, void*, void*, void*, int, int, int, intptr_t, int);
void cub_device_scan(void*, size_t&, void*, void*, int, intptr_t, int, int);
void cub_device_histogram_range(void*, size_t&, void*, void*, int, void*, size_t, intptr_t, int);
size_t cub_device_reduce_get_workspace_size(void*, void*, int, intptr_t, int, int);
size_t cub_device_segmented_reduce_get_workspace_size(void*, void*, int, int, intptr_t, int, int);
size_t cub_device_spmv_get_workspace_size(void*, void*, void*, void*, void*, int, int, int, intptr_t, int);
size_t cub_device_scan_get_workspace_size(void*, void*, int, intptr_t, int, int);
size_t cub_device_histogram_range_get_workspace_size(void*, void*, int, void*, size_t, intptr_t, int);
