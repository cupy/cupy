...
.. envvar:: CUPY_ACCELERATORS
  ...
  The ``cuda_compute`` backend requires the `cuda-cccl <https://pypi.org/project/cuda-cccl/>`_ package and currently accelerates :func:`~cupy.cumsum`, :func:`~cupy.cumprod` and :func:`~cupy.bincount`.
