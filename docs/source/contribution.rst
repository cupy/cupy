...
Once you send a PR, it is automatically tested on `Travis CI <https://travis-ci.org/cupy/cupy/>`_ for Linux, and on `AppVeyor <https://ci.appveyor.com/project/cupy/cupy>`_ for Windows.
