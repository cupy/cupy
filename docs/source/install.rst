...
* `cuTENSOR <https://developer.nvidia.com/cutensor>`_: v1.3 / v1.4 / v1.5
...
* `cuSPARSELt <https://docs.nvidia.com/cuda/cusparselt/>`_: v0.1.0 / v0.2.0
...
* `ROCm <https://rocmdocs.amd.com/en/latest/index.html>`_: v4.0 / v4.2 / v4.3 / v5.0
