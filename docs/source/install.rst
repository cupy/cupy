...
* `CUDA Toolkit <https://developer.nvidia.com/cuda-toolkit>`_: v10.2 / v11.0 / v11.1 / v11.2 / v11.3 / v11.4 / v11.5 / v11.6 / v11.7 / v11.8
...
NumPy/SciPy-compatible API in CuPy v11 is based on NumPy 1.23 and SciPy 1.9, and has been tested against the following versions:
