...
It is utterly important to first identify the performance bottleneck before making any attempt to
code optimization. To help set up a baseline benchmark, CuPy provides a useful utility :func:`cupyx.time.repeat`
...
Because GPU executions run asynchronously with respect to CPU executions, a common pitfall in GPU programming is to
