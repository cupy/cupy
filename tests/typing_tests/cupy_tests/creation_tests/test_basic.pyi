...
# TODO: xp.empty_like(a=x, dtype=float, order='C', shape=(10, 20))
...
# TODO: xp.ones_like(a=x, dtype=float, order='C', shape=(10, 20))
...
# TODO: xp.zeros_like(a=x, dtype=float, order='C', shape=(10, 20))
...
# TODO: xp.full_like(a=x, 30, dtype=float, order='C', shape=(10, 20))
