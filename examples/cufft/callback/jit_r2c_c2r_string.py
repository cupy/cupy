...
//    if (index == 0)
//        printf("signal_size: %i, window_N: %i\n", params->signal_size, params->window_N);
//    return {1.0f, 0.f};
//    return cb_output[index];
...
# Note: we are cheating here! For a rigorous treatment, please refer to
# examples/custom_struct/complex_struct.py.
