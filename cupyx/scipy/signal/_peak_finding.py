...
def _peak_finding(data, comparator, axis, order, mode, results):
    ...
    if data.ndim > 1:
        ...
        n_blocks_x = (data.shape[0] + block_sz_x - 1) // block_sz_x
        n_blocks_y = (data.shape[1] + block_sz_y - 1) // block_sz_y
    ...
    boolrelextrema(num_blocks, block_sz,
                   (data, comp, axis, order, clip, results))
