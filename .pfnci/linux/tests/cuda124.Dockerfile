...
RUN pip install -U 'numpy==2.2.*' 'scipy==1.16.*' 'optuna==3.*' 'cython==3.2.*,!=3.2.6' 'cuda-cccl[minimal-sysctk12]>=1.1.1'
RUN pip uninstall -y mpi4py ml_dtypes cuda-python nvmath-python && \
    pip check
