...
\
    ...
    apt-get -qqy --allow-change-held-packages \
            --allow-downgrades install 'libnccl2=2.26.*+cuda12.9' 'libnccl-dev=2.26.*+cuda12.9' 'libcutensor2-cuda-12=2.3.*' 'libcutensor2-dev-cuda-12=2.3.*'
...
RUN pip install -U 'numpy==2.3.*' 'scipy==1.16.*' 'optuna==4.*' 'cython==3.1.*' 'cuda-python==12.*' 'cuda-pathfinder>=1.3.1'
