...
RUN yum -y install \
    ...
    yum -y install 'libnccl-2.8.*-*+cuda11.2' 'libnccl-devel-2.8.*-*+cuda11.2' 'libcutensor1-1.4.*' 'libcutensor-devel-1.4.*' 'libcusparselt0-0.1.0.*' 'libcusparselt-devel-0.1.0.*' 'libcudnn8-8.1.*-*.cuda11.2' 'libcudnn8-devel-8.1.*-*.cuda11.2'
