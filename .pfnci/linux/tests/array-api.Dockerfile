...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    --allow-downgrades install 'libnccl2=2.11.*+cuda11.5' 'libnccl-dev=2.11.*+cuda11.5' 'libcutensor1=1.4.*' 'libcutensor-dev=1.4.*' 'libcusparselt0=0.7.1.*' 'libcusparselt-dev=0.7.1.*'
