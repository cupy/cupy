...
RUN yum -y install \
    ...
    yum -y install 'libnccl-2.8.*-*+cuda11.1' 'libnccl-devel-2.8.*-*+cuda11.1' 'libcutensor1-1.4.*' 'libcutensor-devel-1.4.*' 'libcudnn8-8.0.*-*.cuda11.1' 'libcudnn8-devel-8.0.*-*.cuda11.1'
