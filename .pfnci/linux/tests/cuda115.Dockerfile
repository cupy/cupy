...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    apt-get -qqy --allow-change-held-packages \
            --allow-downgrades install libnccl2=2.11.*+cuda11.5 libnccl-dev=2.11.*+cuda11.5 libcutensor-dev=1.3.* libcusparselt-dev=0.1.0.* libcudnn8=8.2.*+cuda11.4 libcudnn8-dev=8.2.*+cuda11.4
