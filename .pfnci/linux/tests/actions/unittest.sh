...
compute-sanitizer --tool memcheck --padding 16 $(pyenv which python3) -m pytest "${pytest_opts[@]}" -v -k 'test_multivalue_2d[True-cubic]' cupyx_tests/scipy_tests/interpolate_tests/test_ndgriddata.py || test_retval=$?
exit 1
###
