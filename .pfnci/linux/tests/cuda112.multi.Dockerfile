...
RUN yum -y install \
    ...
    yum -y install 'libnccl-2.16.*-*+cuda11.2' 'libnccl-devel-2.16.*-*+cuda11.2' 'libcutensor1-1.6.*' 'libcutensor-devel-1.6.*' 'libcusparselt0-0.2.0.*' 'libcusparselt-devel-0.2.0.*' 'libcudnn8-8.8.*-*.cuda11.8' 'libcudnn8-devel-8.8.*-*.cuda11.8'
