...
\
    ...
    apt-get -qqy --allow-change-held-packages \
            --allow-downgrades install 'libnccl2=2.20.*+cuda12.5' 'libnccl-dev=2.20.*+cuda12.5' 'libcutensor2=2.0.*' 'libcutensor-dev=2.0.*' 'libcusparselt0=0.2.0.*' 'libcusparselt-dev=0.2.0.*' 'libcudnn8=8.8.*+cuda12.0' 'libcudnn8-dev=8.8.*+cuda12.0'
